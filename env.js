 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.dyuta.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.notacoder.aptrade'; // ios bundle id
const PACKAGE = 'com.notacoder.aptrade'; // android package name
const NAME = 'aptrade'; // app name
const EXPO_ACCOUNT_OWNER = 'notacoder'; // expo account owner
const EAS_PROJECT_ID = 'b9dc25b4-3bf4-4cca-9b72-e1d0d571d83f'; // eas project id
const SCHEME = 'aptrade'; // app scheme
